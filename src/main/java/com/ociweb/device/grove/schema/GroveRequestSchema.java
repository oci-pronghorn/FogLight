...
public class GroveRequestSchema extends MessageSchema {
    ...
    public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
            new int[]{0xc1400003,0x80200000,0x80000001,0xc1200003,0xc1400004,0x80200000,0x80000001,0x80000002,0xc1200004,0xc1400003,0x80200003,0x80000004,0xc1200003},
            (short)0,
            new String[]{"DigitalSet","Connector","Value",null,"DigitalSet","Connector","value","Duration",null,"AnalogSet","Connector","Value",null},
            new long[]{110, 111, 112, 0, 120, 111, 112, 113, 0, 140, 141, 142, 0},
            new String[]{"global",null,null,null,"global",null,null,null,null,"global",null,null,null},
            "GroveRequest.xml",
            new long[]{2, 2, 0},
            new int[]{2, 2, 0});
    ...
    public static final int MSG_ANALOGSET_140 = 0x00000009;
