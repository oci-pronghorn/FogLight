...
public class HTTPSClientTest {
	...
	public void buildPipeline() {
		...
		buildHTTPClientGraph(gm, hardware, inputsCount, outputsCount, maxPartialResponses, maxListeners, ccm,
	...
	private void buildHTTPClientGraph(GraphManager gm, HardwareImpl hardware, int inputsCount, int outputsCount,
			int maxPartialResponses, int maxListeners, ClientConnectionManager ccm, IntHashTable listenerPipeLookup,
			PipeConfig<NetRequestSchema> netREquestConfig, PipeConfig<TrafficReleaseSchema> trafficReleaseConfig,
			PipeConfig<TrafficAckSchema> trafficAckConfig, PipeConfig<ClientNetRequestSchema> clientNetRequestConfig,
			PipeConfig<NetParseAckSchema> parseAckConfig, PipeConfig<ClientNetResponseSchema> clientNetResponseConfig,
			PipeConfig<NetResponseSchema> netResponseConfig, Pipe<NetRequestSchema>[] input,
			Pipe<TrafficReleaseSchema>[] goPipe, Pipe<NetResponseSchema>[] toReactor, Pipe<TrafficAckSchema>[] ackPipe) {
