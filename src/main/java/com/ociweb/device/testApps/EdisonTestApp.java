 ...
 */
public class EdisonTestApp {
    private static final Logger logger = LoggerFactory.getLogger(EdisonTestApp.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Initialization failed. This is not an Edison.");
            return;
        }
