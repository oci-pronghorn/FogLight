...
/**
 * TODO: I'm not good with circuits...besides P18 and P19, which ones need to be changed?
 *
 * @author Brandon Sanders [brandon@alicorn.io]
 */
public class GrovePiConstants {
    
    public static final short[] GPIO_PINS = new short[] {130, //IO 0 D 0
        131, //IO 1 D 1
        128, //IO 2 D 2
        12,  //IO 3 D 3 
        129, //IO 4 D 4
    ...
    public static final short[] GPIO_PIN_MODES = new short[] {130, //IO 0 D 0
        131, //IO 1 D 1
        128, //IO 2 D 2
        12,  //IO 3 D 3 
        129, //IO 4 D 4
    ...
    public static final byte[] ANALOG_CONNECTOR_TO_PIN = new byte[] {14, //A0
        15, //A1
        16, //A2
        17, //A3
        18, //A4
    ...
    public static final short[] OUTPUT_ENABLE = new short[] {248, //IO 0 D 0
        249, //IO 1 D 1
        250, //IO 2 D 2
        251, //IO 3 D 3 
        252, //IO 4 D 4
    ...
    public static final short[] PULL_UP_ENABLE = new short[] {216, //IO 0 D 0
        217, //IO 1 D 1
        218, //IO 2 D 2
        219,  //IO 3 D 3 
        220, //IO 4 D 4
    ...
    public static final GroveConnect[] i2cPins = new GroveConnect[] {
        new GroveConnect(GroveTwig.I2C, 3),
        new GroveConnect(GroveTwig.I2C, 5)};
