...
public class EdisonConstants {
    ...
    public static final HardConnection[] i2cPins = new HardConnection[] {new HardConnection(GroveTwig.I2C,18,ConnectionType.Grove),new HardConnection(GroveTwig.I2C,19,ConnectionType.Grove)};
