...
public class ValveSchema extends MessageSchema<ValveSchema> {
    ...
    public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
            ...
            new String[]{"ValveSerialNumber","Station","Timestamp","ValveSerialNumber",null,"LifeCycleCount",
                    ...
                    "Timestamp","Fault",null,"PressureFault","Station","Timestamp","PressureFault",null,
    ...
    public static final int MSG_PRESSUREFAULT_350_FIELD_PRESSUREFAULT_30 = 0x01400004;
    ...
    public static void consumePressureFault(Pipe<ValveSchema> input) {
        ...
        StringBuilder fieldPressureFault = PipeReader.readUTF8(input,MSG_PRESSUREFAULT_350_FIELD_PRESSUREFAULT_30,new StringBuilder(PipeReader.readBytesLength(input,MSG_PRESSUREFAULT_350_FIELD_PRESSUREFAULT_30)));
    }
    ...
    public static void publishPressureFault(Pipe<ValveSchema> output, int fieldStation, long fieldTimestamp, CharSequence fieldPressureFault) {
        ...
        PipeWriter.writeUTF8(output,MSG_PRESSUREFAULT_350_FIELD_PRESSUREFAULT_30, fieldPressureFault);
        PipeWriter.publishWrites(output);
    }
