...
public class ValveSchema extends MessageSchema<ValveSchema> {
    ...
    public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
            ...
            new String[]{"ValveSerialNumber", "Station", "Timestamp", "ValveSerialNumber", null, "LifeCycleCount",
                    ...
                    "Timestamp", "Fault", null, "PressureFault", "Station", "Timestamp", "PartNumber", null,
                    "LeakFault", "Station", "Timestamp", "Fault", null, "DataFault", "Station", "Timestamp",
                    "Fault", null, "PressurePoint", "Station", "Timestamp", "PressurePoint", null},
            new long[]{311, 1, 2, 11, 0, 312, 1, 2, 12, 0, 313, 1, 2, 13, 0, 314, 1, 2, 14, 0, 315, 1, 2, 15, 0, 316, 1, 2, 16, 0, 317, 1, 2, 17, 0, 318, 1, 2, 18, 0, 330, 1, 2, 30, 0, 340, 1, 2, 3, 0, 350, 1, 2, 30, 0, 360, 1, 2, 3, 0, 362, 1, 2, 3, 0, 319, 1, 2, 19, 0},
    ...
    public static final int MSG_VALVEFAULT_340_FIELD_FAULT_3 = 0x00000004;
    ...
    public static final int MSG_PRESSUREFAULT_350_FIELD_PARTNUMBER_30 = 0x01400004;
    ...
    public static final int MSG_LEAKFAULT_360_FIELD_FAULT_3 = 0x00000004;
    ...
    public static final int MSG_DATAFAULT_362_FIELD_FAULT_3 = 0x00000004;
    ...
    public static void consumeValveFault(Pipe<ValveSchema> input) {
        ...
        int fieldFault = PipeReader.readInt(input, MSG_VALVEFAULT_340_FIELD_FAULT_3);
    }
    ...
    public static void consumePressureFault(Pipe<ValveSchema> input) {
        ...
        StringBuilder fieldPartNumber = PipeReader.readUTF8(input, MSG_PRESSUREFAULT_350_FIELD_PARTNUMBER_30, new StringBuilder(PipeReader.readBytesLength(input, MSG_PRESSUREFAULT_350_FIELD_PARTNUMBER_30)));
    }
    ...
    public static void consumeLeakFault(Pipe<ValveSchema> input) {
        ...
        int fieldFault = PipeReader.readInt(input, MSG_LEAKFAULT_360_FIELD_FAULT_3);
    }
    ...
    public static void consumeDataFault(Pipe<ValveSchema> input) {
        ...
        int fieldFault = PipeReader.readInt(input, MSG_DATAFAULT_362_FIELD_FAULT_3);
    }
    ...
    public static void publishValveFault(Pipe<ValveSchema> output, int fieldStation, long fieldTimestamp, int fieldFault) {
        ...
        PipeWriter.writeInt(output, MSG_VALVEFAULT_340_FIELD_FAULT_3, fieldFault);
        PipeWriter.publishWrites(output);
    }

    public static void publishPressureFault(Pipe<ValveSchema> output, int fieldStation, long fieldTimestamp, CharSequence fieldPartNumber) {
        ...
        PipeWriter.writeUTF8(output, MSG_PRESSUREFAULT_350_FIELD_PARTNUMBER_30, fieldPartNumber);
        PipeWriter.publishWrites(output);
    }

    public static void publishLeakFault(Pipe<ValveSchema> output, int fieldStation, long fieldTimestamp, int fieldFault) {
        ...
        PipeWriter.writeInt(output, MSG_LEAKFAULT_360_FIELD_FAULT_3, fieldFault);
        PipeWriter.publishWrites(output);
    }

    public static void publishDataFault(Pipe<ValveSchema> output, int fieldStation, long fieldTimestamp, int fieldFault) {
        ...
        PipeWriter.writeInt(output, MSG_DATAFAULT_362_FIELD_FAULT_3, fieldFault);
        PipeWriter.publishWrites(output);
    }
